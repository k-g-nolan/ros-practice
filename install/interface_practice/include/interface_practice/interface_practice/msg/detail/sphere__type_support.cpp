...
{
  new (message_memory) interface_practice::msg::Sphere(_init);
}

void Sphere_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface_practice::msg::Sphere *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sphere_message_member_array[2] = {
  {
    ...
    offsetof(interface_practice::msg::Sphere, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface_practice::msg::Sphere, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sphere_message_members = {
  "interface_practice::msg",  // message namespace
  "Sphere",  // message name
  2,  // number of fields
  sizeof(interface_practice::msg::Sphere),
...
get_message_type_support_handle<interface_practice::msg::Sphere>()
{
  return &::interface_practice::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface_practice, msg, Sphere)() {
  return &::interface_practice::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
